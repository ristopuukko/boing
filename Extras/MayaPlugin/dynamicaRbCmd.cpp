...
MString dynamicaRbCmd::typeName("dynamicaRb");

dynamicaRbCmd::dynamicaRbCmd()
 : argParser(0)
{}
...
MStatus
dynamicaRbCmd::doIt(const MArgList &args)
{
    MStatus stat;
...
MStringArray dynamicaRbCmd::parseArguments(MString arg, MString token) {
...
MStatus dynamicaRbCmd::createRigidBody(collision_shape_t::pointer  collision_shape, 
                                        MObject node,
                                        MString name,
                                        MVector vel,
                                        MVector pos,
...
collision_shape_t::pointer dynamicaRbCmd::createCollisionShape(const MObject& node)
{
...
MStatus dynamicaRbCmd::deleteRigidBody() {
    return MS::kSuccess;
}


MString dynamicaRbCmd::checkAttribute(MString attr) {
    MString result;
...
MStatus dynamicaRbCmd::setBulletVectorAttribute(MObject node, MString attr, MVector vec) {
...
MVector dynamicaRbCmd::getBulletVectorAttribute(MObject node, MString attr) {
...
MObject dynamicaRbCmd::nameToNode( MString name ) {
...
MPlug dynamicaRbCmd::nameToNodePlug( MString attrName, MObject nodeObject ) {
